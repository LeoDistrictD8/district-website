              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center w-full">
                ...
                <motion.div 
                  variants={{
                    ...
                    visible: { opacity: 1, x: 0, rotateY: 0, transition: { duration: 1.2, ease: [0.22, 1, 0.36, 1], delay: 0.3 } },
                    exit: { opacity: 0, x: -100, rotateY: -20, transition: { duration: 0.6 } }
                  }}
                ...
                <motion.div 
                  variants={{
                    ...
                    visible: { opacity: 1, scale: 1, transition: { duration: 1, ease: [0.22, 1, 0.36, 1], delay: 0.5 } },
                ...
                <motion.div 
                  variants={{
                    hidden: { opacity: 0, x: 100, rotateY: -30 },
                    visible: { opacity: 1, x: 0, rotateY: 0, transition: { duration: 1.2, ease: [0.22, 1, 0.36, 1], delay: 0.7 } },
                    exit: { opacity: 0, x: 100, rotateY: 20, transition: { duration: 0.6 } }
                  }}
                  style={{ perspective: 1000 }}
                ...
                >
                  ...
                  <img 
                    src={aboutData.logo} 
                    alt="District Logo" 
                    className="w-[250px] h-[250px] object-contain drop-shadow-[0_0_30px_rgba(212,175,55,0.2)]"
                  />
                </motion.div>
