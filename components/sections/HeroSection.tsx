...
export function HeroSection({ isActive, direction }: HeroSectionProps) {
  ...
  return (
    <section className="absolute inset-0 flex items-center justify-center pt-24 overflow-hidden pointer-events-none">
      ...
      <div className="container px-4 md:px-6 flex flex-col items-center text-center max-w-4xl pointer-events-auto z-10">
            ...
            >
              <motion.div 
                variants={{
                  ...
                  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.2 } },
                  exit: { opacity: 0, y: -150, scale: 0.8, transition: { duration: 0.6 } }
                }}
              ...
              <motion.h1 
                variants={{
                  ...
                  visible: { opacity: 1, scale: 1, rotateX: 0, transition: { duration: 1.2, ease: [0.16, 1, 0.3, 1], delay: 0.3 } },
                  exit: { opacity: 0, scale: 0.5, y: -200, transition: { duration: 0.7 } }
                }}
                style={{ perspective: 1000 }}
                className="font-heading text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-br from-foreground to-foreground/70"
              >
              ...
              <motion.p 
                variants={{
                  ...
                  visible: { opacity: 1, x: 0, rotateY: 0, transition: { duration: 1, ease: [0.22, 1, 0.36, 1], delay: 0.5 } },
                  exit: { opacity: 0, x: 200, rotateY: 30, transition: { duration: 0.6 } }
                }}
                style={{ perspective: 1000 }}
              ...
              <motion.div 
                variants={{
                  ...
                  visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.7 } },
              ...
              <motion.div
                ...
                className="fixed bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 pointer-events-none"
              >
                <span className="text-[10px] uppercase tracking-[0.3em] text-white/50 font-medium">{heroData.scrollText}</span>
