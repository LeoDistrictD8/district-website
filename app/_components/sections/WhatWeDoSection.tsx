        ...
        <AnimatePresence mode="wait">
          {isActive && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 w-full">
                {whatWeDoData.blocks.map((block, index) => (
                  <motion.div
                    ...
                    className="flex flex-col py-3 px-8 md:p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md shadow-xl hover:bg-white/10 transition-colors group relative overflow-hidden"
                  >
