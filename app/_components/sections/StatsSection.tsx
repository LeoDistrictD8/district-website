              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 w-full text-center">
                {statsData.map((stat, index) => (
                  ...
                  >
                    ...
                    <motion.div 
                      className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-gold to-yellow-600 mb-2 font-heading flex items-center justify-center"
                    >
                      <NumberTicker 
